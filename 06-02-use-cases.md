...
交替场景：  
- 如果小组的进入权限是不需要验证，则用户或机构选择小组申请加入后直接加入到小组当中；  
- 如果小组的进入权限是不允许申请加入，则用户或机构点击申请加入时弹出提示信息；  
- 如果小组组长不同意用户或机构进群，则系统发送信息通知申请者；  
...
交替场景：  
- 如果用户是小组的组长，则用户不能直接退出小组，需要先转让小组组长之后才能退出或直接解散小组。   
